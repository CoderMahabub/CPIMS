...
<h1 align=center> Order Delivery Information Search</h1>
<form method="post" action="order_delivery_information_search.php">
<table align=center>
       <tr>
...
$result = mysqli_query($con, "SELECT * FROM order_delivery_information
